...
sentiment = pipeline("sentiment-analysis", model="roberta-base")
...
print(result3)
# sentiment = pipeline("sentiment-analysis", model="roberta-base")
[{'label': 'LABEL_1', 'score': 0.5358943343162537}]
[{'label': 'LABEL_1', 'score': 0.535211443901062}]
[{'label': 'LABEL_1', 'score': 0.535454511642456}]
